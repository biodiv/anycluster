    ...
    def test__init__(self):
        ...
        for geometry_type in GEOMETRY_TYPES:
            for clustertype in CLUSTER_TYPES:
                cluster_cache = ClusterCache(geometry_type, TEST_ZOOM, clustertype)
                ...
                self.assertEqual(cluster_cache.filters, [])
        ...
        for geometry_type in GEOMETRY_TYPES:
            for clustertype in CLUSTER_TYPES:
                ...
                for geometry in [GEOJSON_RECTANGLE, GEOJSON_POLYGON]:
                    ...
                    cluster_cache_2 = ClusterCache(geometry_type, TEST_ZOOM, clustertype)
                    ...
                    gt_cluster_cache = ClusterCache(other_geometry_type, TEST_ZOOM, clustertype)
                    ...
                    zoom_cluster_cache = ClusterCache(geometry_type, zoom, clustertype)
                    ...
                    ct_cluster_cache = ClusterCache(geometry_type, TEST_ZOOM, other_clustertype)

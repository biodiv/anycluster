...
class MapClusterer():
    ...
    def gridCluster(self, clustercells, filters):
        ...
        for cell in clustercells:
            ...
            if self.srid_db != self.input_srid:
                self.maptools.point_AnyToAny(cell_topright, self.srid_db, self.input_srid)
                self.maptools.point_AnyToAny(cell_bottomleft, self.srid_db, self.input_srid)
    ...
    def getKmeansClusterContent(self, x, y, kmeansList, filters):
        ...
        cell_topright, cell_bottomleft, poly = self.clusterCellToBounds(cell_str)
    ...
    def kmeansCluster(self, clustercells, filters):
        ...
        for cell in clustercells:
            ...
            for cell in cellpins:
                ...
                pins.append({'ids': cell.id, 'count':cell.count, 'center':{'x':point.x, 'y':point.y}, 'pinimg':pinimg})
